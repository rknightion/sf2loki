...
Note: the Grafana dashboards (``deploy/grafana/dashboards/*.json``) and rule pack
(``deploy/grafana/rules/**``) are hand-authored v2-schema / Grafana-managed
resources, not generated — there is no drift gate for them (see
