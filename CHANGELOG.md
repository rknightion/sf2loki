...
## [1.1.0](https://github.com/rknightion/sf2loki/compare/v1.0.0...v1.1.0) (2026-09-26)
...
* **docs:** stop advertising install routes that do not exist ([6345eeb](https://github.com/rknightion/sf2loki/commit/6345eebc593226cb141455394df5a0a5e58793dc))
...
* adopt canonical routing and bounded root rescue ([18d3c45](https://github.com/rknightion/sf2loki/commit/18d3c45058c3a54dee240a74f636c9fad5b2dd5c))
...
* **agents:** review fix sf2loki root AGENTS.md ([5557e3f](https://github.com/rknightion/sf2loki/commit/5557e3fc773d1867d1141d6cf8ea82ae175430fc))
* **agents:** review fix src/sf2loki/coordinate ([165492a](https://github.com/rknightion/sf2loki/commit/165492ad99df90778766d428d7496f3e19aba94c))
* **agents:** review fix src/sf2loki/sinks ([fd42959](https://github.com/rknightion/sf2loki/commit/fd429594ced688890cc4dbdabdf2f79bebb4ba03))
* **agents:** review fix src/sf2loki/sources ([736b693](https://github.com/rknightion/sf2loki/commit/736b6933081c0fce332ea0c09288acad8b069f31))
* **agents:** sf2loki root to AGENTS.md standard ([7c708aa](https://github.com/rknightion/sf2loki/commit/7c708aa6a1807fb57870b9bb69b97b5a1cccd603))
* **agents:** src/sf2loki/auth to AGENTS.md standard ([2ac5b40](https://github.com/rknightion/sf2loki/commit/2ac5b40c0f8e0e172a73515b4072dd41c263fe50))
* **agents:** src/sf2loki/coordinate to AGENTS.md standard ([7c50639](https://github.com/rknightion/sf2loki/commit/7c506396f681983efba90fc3422c49e8120b293e))
* **agents:** src/sf2loki/salesforce to AGENTS.md standard ([fd2d37e](https://github.com/rknightion/sf2loki/commit/fd2d37e48898952ff80f211e131347c19732a851))
* **agents:** src/sf2loki/sinks to AGENTS.md standard ([c9e1ae5](https://github.com/rknightion/sf2loki/commit/c9e1ae5d212bc2511016849ce6fdfc69add6c3e6))
* **agents:** src/sf2loki/sources to AGENTS.md standard ([4f64d1b](https://github.com/rknightion/sf2loki/commit/4f64d1bd7a3492f48b237ed597cfc12b954b787b))
* **agents:** src/sf2loki/state to AGENTS.md standard ([c230d03](https://github.com/rknightion/sf2loki/commit/c230d038d330a00936011aae5442d6c3bb710703))
* align recovery contracts and compaction evidence ([efc1639](https://github.com/rknightion/sf2loki/commit/efc16396e174d9204f9e0af826a7f095f9ef1be2))
...
* opt in to public Backlog pages ([07001dd](https://github.com/rknightion/sf2loki/commit/07001dd63507a885b0b466f9f49ce617c71e6904))
* publish canonical agent documents ([d72c9ad](https://github.com/rknightion/sf2loki/commit/d72c9ada5ea9ae00fc4d290d0d1b579812d95aeb))
* publish canonical agent documents ([66c2023](https://github.com/rknightion/sf2loki/commit/66c202303132ada80ab694d0aa89d2c9535a83a7))
* publish canonical agent documents ([f4de6b6](https://github.com/rknightion/sf2loki/commit/f4de6b652b29e8827ec62a731afe8de8302d0422))
* publish canonical agent documents ([ecb0213](https://github.com/rknightion/sf2loki/commit/ecb0213524e9876f088b83ba30279ac1cd5af887))
* publish canonical agent documents ([457fca6](https://github.com/rknightion/sf2loki/commit/457fca6e0d72dfad2b3efbc60f3e7244ef43c24f))
* publish canonical agent documents ([aa8cc6b](https://github.com/rknightion/sf2loki/commit/aa8cc6bd56bbdb6abab43f12b37a8eb8e887f43c))
* publish canonical agent documents ([f22cf95](https://github.com/rknightion/sf2loki/commit/f22cf955fbf4fad5267013f84243fc782314ba52))
* publish canonical agent documents ([b212e35](https://github.com/rknightion/sf2loki/commit/b212e350f127c428325c1294b9ecaa543bf783fb))
* publish canonical agent documents ([ebe90bb](https://github.com/rknightion/sf2loki/commit/ebe90bb2a87973d192bf3b1e441a235027c207f4))
* publish canonical agent documents ([c379515](https://github.com/rknightion/sf2loki/commit/c379515a6b53d173895a2d5ec94b1e6fbd464e41))
* publish canonical agent documents ([e6a1917](https://github.com/rknightion/sf2loki/commit/e6a1917bb74abd955a4fd72e6b2bf876cb88b24b))
* publish canonical agent documents ([05a6cc6](https://github.com/rknightion/sf2loki/commit/05a6cc612fad9334e5956027d6726b4a11b947b0))
* publish canonical agent documents ([b7428a2](https://github.com/rknightion/sf2loki/commit/b7428a20bff3180f9d1df54dacb9cfbc6d0c49ba))
* publish canonical agent documents ([9803be0](https://github.com/rknightion/sf2loki/commit/9803be0064825d80caca48c89f6d170f7c8105a0))
* publish canonical agent documents ([1f46c89](https://github.com/rknightion/sf2loki/commit/1f46c89e9ffc8b7376532524ab8475b888599778))
* publish canonical agent documents ([df2df54](https://github.com/rknightion/sf2loki/commit/df2df54be064408ee50158b23f0a1689fa9f708a))
* publish canonical agent documents ([cc5f66b](https://github.com/rknightion/sf2loki/commit/cc5f66bda891b05e5dd6419856ce86776a92615c))
...
* reconcile local fan-out overrides with root resolution authority ([c356c02](https://github.com/rknightion/sf2loki/commit/c356c029ec7928660f44fce8640df573015a03a4))
...
* sync approved fan-out scheduling and route verification ([0a352b6](https://github.com/rknightion/sf2loki/commit/0a352b628d4888d86e593cfbf9f535e43013973b))
...
* sync authorised Astra root judgement ([f7f25ef](https://github.com/rknightion/sf2loki/commit/f7f25ef9f775e152bffb2d3bc6bde521f1a8cac1))
* sync authorised Astra root judgement ([fc1ab0e](https://github.com/rknightion/sf2loki/commit/fc1ab0edf4ae975c7b008eee8f1e518b56f07c7e))
* sync cost-aware fan-out routing and prompt guidance ([0595e70](https://github.com/rknightion/sf2loki/commit/0595e70c0dd87cfa70e18a4e8277b6267f557e0d))
* sync fan-out async decision-only guidance ([ddb9550](https://github.com/rknightion/sf2loki/commit/ddb9550fa347fb6465c34e98fa4c7967af396cfa))
* sync fan-out protocol from agent-docs ad7abd2 ([8e528e4](https://github.com/rknightion/sf2loki/commit/8e528e43d21f47e464fb0499439bbaa187130cda))
* sync fan-out protocol, delegated root authority for unattended runs ([5efc499](https://github.com/rknightion/sf2loki/commit/5efc4997f456327afee4086457fbaa7f8c29a5d9))
* sync fan-out protocol, explicit add does not bound the commit ([4bb5de2](https://github.com/rknightion/sf2loki/commit/4bb5de25f71491261ae658279c6bdc671137d730))
* sync fixed Astra low orchestration and rescue routing ([f5c615b](https://github.com/rknightion/sf2loki/commit/f5c615b46d360da21b72611e48a131f98be1d8cc))
...
* sync polling and integration contracts ([c2c549d](https://github.com/rknightion/sf2loki/commit/c2c549d554976ef4e21b270d0d2c1621f091d4f9))
* sync root async question policy ([a57105d](https://github.com/rknightion/sf2loki/commit/a57105d8e80492d10cc123e631b8f05a5bc04696))
* sync same-session fan-out recovery contract ([c77c4ac](https://github.com/rknightion/sf2loki/commit/c77c4acbaa719e640966f8faffdfe367d8d0fc05))
* sync wave orchestration and existing-root contracts ([96178ba](https://github.com/rknightion/sf2loki/commit/96178bacaaebe6b76d1210a4df3a9b5661b1d7af))
* sync wave reliability and worktree contracts ([c92d55a](https://github.com/rknightion/sf2loki/commit/c92d55ab96649f869ee8f6e831c0402e261fbf68))
